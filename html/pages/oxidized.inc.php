            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="list">
                    <div class="table-responsive">
                        <button type='submit' class='btn btn-success btn-sm' aria-label='Reload node list' data-toggle='modal' name='btn-reload-nodes' id='btn-reload-nodes'><i class='fa fa-refresh'></i> Reload node list</button>
